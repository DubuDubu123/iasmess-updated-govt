    ...
    public function getAllTypes(QueryFilterContract $queryFilter, Request $request)
{
    ...
    $query->join('users as k', 'sports_booking.user_id', '=', 'k.id')
          ->select('sports_booking.*', 'k.name as user_name'); // Select all sports_booking fields and user's name
    ...
    $query->orderBy('sports_booking.created_at', 'DESC');
