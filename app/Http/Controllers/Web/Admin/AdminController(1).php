...
public function updateProfile(UpdateProfileRequest $request, User $user)
{
    ...
    if ($uploadedFile = $request->file('profile_picture')) {
        $filePath = $uploadedFile->store('profile_pictures', 'public');
        $updated_user_params['profile_picture'] = $filePath;
    }
    ...
    $message = trans('success_messages.admin_profile_updated_successfully');
