...
class SMS implements SMSContract
{
    ...
    public function send($numbers = null, $message = null, $type = null)
    {
        ...
        return $providerInstance->sendsms($this->numbers, $this->message, $this->type);
    }

     public function send1($numbers = null, $message = null, $type = null)
    {
        // echo $type;
        // exit;
        $this->to($numbers)->message($message);
...
//  dd($this->settings);
        ...
        return $providerInstance->sendsms($this->numbers, $this->message, $type);
    }
     public function whatsappsend($numbers = null, $message = null)
    {
        
        $url = env('WHATSAPP_API_URL') ."?"."userid=2000245437&password=".urlencode('jXwjb#Gm')."&send_to=".$numbers."&v=1.1&format=json&msg_type=TEXT&method=SENDMESSAGE&msg=".$message."";
        // echo $url;
        // exit;
        $ch = curl_init();
