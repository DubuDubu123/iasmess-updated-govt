...
Route::middleware(['guest', 'prevent.clickjacking','hsts','validateRedirect'])->namespace('Admin')->group(function () {
...
Route::middleware(['auth:web', 'prevent.clickjacking','hsts'])->group(function () {
    ...
    Route::middleware(role_middleware(Role::webPanelLoginRoles()))->group(function () {
        ...
        Route::namespace('Admin')->group(function () {
            ...
            Route::prefix('types')->group(function () {
                Route::post('/send-payment-link/{booking}', 'Roomcontroller@send_payment_link');
                Route::get('/send-payment-link-checkout/{booking}', 'Roomcontroller@send_payment_link_checkout');
                ...
                Route::get('/get-tariff', 'Roomcontroller@getTariff');
            });
            Route::prefix('party')->group(function () {
                ...
                Route::get('/availability-view', 'PartyController@availability_view'); 
                Route::get('/availability-view/fetch', 'PartyController@availability_view_fetch');
            ...
            Route::prefix('party-booking')->group(function () {
                ...
                Route::get('/send-payment-link-checkout/{booking}', 'PartyBookingController@send_payment_link_checkout');
                Route::post('/send-payment-link/{booking}', 'PartyBookingController@send_payment_link'); 
            ...
            Route::prefix('sports-booking')->group(function () {
                ...
                Route::get('/sbiepay', 'SportsController@payment_link');
            });
...
//Fleet drivers
    ...
    Route::group(['prefix' => 'fleet-drivers'], function () {
        ...
        // Route::group(['prefix' => 'admins',  'middleware' => 'permission:admin'], function () {
            ...
            Route::post('profile/update_password/{user}', 'AdminController@updatepassword');
            Route::post('profile/upload-image', 'AdminController@uploadImage');
...
//search
            ...
            // Route::get('{user}/{payment_link}', 'UserController@payment_link');
...
Route::group(['prefix' => 'reports'], function () {
    ...
    Route::get('/room-booking', 'ReportController@bookingReports');
