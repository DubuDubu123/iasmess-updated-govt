        ...
        <tr>
          <td colspan="2" style="text-align: center;">
            <div class="info">
              ...
              <p style="font-size: 10px; line-height: 10px !important; margin-bottom: 0px !important;">jsprotocol@tn.gov.in</p>
              <p style="font-size: 10px; line-height: 10px !important">289-335-6503</p>
            </div>
          </td>
        </tr>
        <tr>
          <td style="vertical-align: top; margin-top: 10px;width:197px">
            <div class="info1">
