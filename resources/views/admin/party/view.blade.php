...
<img src="{{ isset($booking->user) && $booking->user->profile_picture ? $booking->user->profile_picture : 'https://cdn-icons-png.flaticon.com/512/149/149071.png' }}" width="100%" height="100%">
...
<p><i class="fa fa-user" aria-hidden="true"></i> <span style="font-size: 15px;">{{ $booking->user->salutation }}{{ $booking->user->name }} </span>
</p>


@if($booking->user)
    <p><i class="fa fa-phone" aria-hidden="true"></i> <span style="font-size: 15px;">
        {{ $booking->user->mobile ?? 'Mobile not available' }}
    </span></p>

    <p><i class="fa fa-envelope" aria-hidden="true"></i> <span style="font-size: 15px;">
        {{ $booking->user->email ?? 'Email not available' }}
    </span></p>

    <p><i class="fa fa-home" aria-hidden="true"></i> <span style="font-size: 15px;">
        {{ $booking->user->address ?? 'Address not available' }}
    </span></p>
@else
    <p><span>User not available</span></p> <!-- Fallback if user record doesn't exist -->
@endif
