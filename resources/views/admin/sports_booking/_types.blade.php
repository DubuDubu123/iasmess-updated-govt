...
">Booked</button>
    ...
    <button class="btn btn-success btn-sm" style="  background: blue;   border-color: transparent;
">Checked-In</button>
...
<td><a href="{{url('sports-booking/view',$result->id)}}"><span class="label label-success">View   </span></a> </td> 
</tr>
@endforeach
@endif
</tbody>
