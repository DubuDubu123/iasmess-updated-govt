...
<section class="content" style="margin-left:25px">
    ...
    margin-right: 20px;
">
<a href="http://iasmess.dubudubutechnologies.com/sports-booking">
  ...
  <div id="invoice" class="effect2">
    <div class="page-tools" style="text-align: right;">
      <div class="action-buttons" style="margin-bottom: 20px;">
        <a class="btn bg-white btn-light mx-1px text-95" href="{{url('/')}}/sports-booking/export_pdf/{{$booking->id}}" data-title="PDF" style="background:#0a7e8c !important; color: white;">
