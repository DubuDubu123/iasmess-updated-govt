            ...
            <div class="col-12">
                ...
                <div class="box-header with-border">
                            <a href="{{url('/')}}/sports-booking">
                                <button class="btn btn-danger  btn-sm pull-right" type="submit" style="color:white;">
...
">{{$booking->user->address}} </span></p>
                                ...
                                <!--    <span class="value-data" style=" background: red;display: inline;padding: 5px;border-radius: 3px;color: white;">Cencelled</span>-->
                                <!--    @else -->
                                ...
                                <div class="form-group">
                                    <div class="col-12"> 
                                        ...
                                        <i class="fa fa-trash" aria-hidden="true" style="color:white" style="color:white;"></i>
