                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <h5 class="font-weight-600 p-5" style="color:black;font-size:21px;padding-left: 20px !important;">Booking Status (<span class="font-weight-600 p-5 heading-top" style="color:black;font-size:21px;    vertical-align: top;">Today</span>)</h5>
                                @endif
                            ...
                            <div class="box-body "> 
                                ...
                                <img src="{{asset('assets/img/Check-in.png')}}" style="width:60px;" class="img-fluid" alt="">
                               ...
                               <h1 class="font-weight-600 sports-count" style="  text-align: right; padding-right: 20px;font-size:38px">{{$sports_count}}</h1>
                                ...
                                <a  href="{{url('/users')}}">
                                <div class="box p-5" style="text-align: left;border-radius:10px;padding-left: 25px !important;background: #fff !important;">
                                <img src="{{asset('assets/img/pending_user.png')}}" style="width:60px;" class="img-fluid" alt="">
                                <!-- <span class="info-box-icon " style="background-color:#0A7E8C;border-radius:50%;dispaly:block;margin:auto;width:50px;height:50px;line-height:54px;"><i class="ion ion-clipboard text-dark"></i></span> -->
                                <h5 class="font-weight-600 p-5" >Pending User Approvals</h5> 
                                ...
                                <!--<a  href="{{url('/room-booking')}}">-->
                                <!--<div class="box p-5" style="text-align: left;border-radius:10px;padding-left: 25px !important;background: #fff !important;">-->
                                <!--<img src="{{asset('assets/img/pending_booking_approval.png')}}" style="width:60px;" class="img-fluid" alt="">-->
                                <!-- <span class="info-box-icon " style="background-color:#0A7E8C;border-radius:50%;dispaly:block;margin:auto;width:50px;height:50px;line-height:54px;"><i class="ion ion-clipboard text-dark"></i></span> -->
                                <!--<h5 class="font-weight-600 p-5" >Pending Booking Approvals</h5> -->
                                <!--<h1 class="font-weight-600" style="  text-align: right; padding-right: 20px;font-size:38px">{{$pending_approval}}</h1>-->
                                <!--</div>-->
                                <!--</a>-->
                                <!--</div>-->
                                ...
                                <!--<a  href="{{url('/users')}}">-->
                                <!--<div class="box p-5" style="text-align: left;border-radius:10px;padding-left: 25px !important;background: #fff !important;">-->
                                <!--<img src="{{asset('assets/img/payment_pending.png')}}" style="width:60px;" class="img-fluid" alt="">-->
                                <!-- <span class="info-box-icon " style="background-color:#0A7E8C;border-radius:50%;dispaly:block;margin:auto;width:50px;height:50px;line-height:54px;"><i class="ion ion-clipboard text-dark"></i></span> -->
                                <!--<h5 class="font-weight-600 p-5" >Pending Payment</h5> -->
                                <!--<h1 class="font-weight-600" style="  text-align: right; padding-right: 20px;font-size:38px">{{$pending_users}}</h1>-->
                                <!--</div>-->
                                <!--</a>-->
                                <!--</div>-->
...
@endif
            ...
            @if(auth()->user()->hasRole('user'))
              <div style="color:black;font-size:18px">
                               <h5 class="font-weight-600 p-5" style="color:black;font-size:21px;    PADDING-LEFT: 20PX ! IMPORTANT;">Booking Status (<span class="font-weight-600 p-5 heading-top" style="color:black;font-size:21px;    vertical-align: top;">Last 6 Months</span>)</h5>
            ...
            <div style="color:black;font-size:18px">
                                ...
                                @if(auth()->user()->hasRole("user"))
                                Bookings Distribution (Last 6 Months) 
                                @else
                                Bookings Distribution (Today)
                                @endif
