                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment_opt[]" id="payment_opt" class="form-control select2" multiple="multiple" data-placeholder="@lang('view_pages.select') @lang('view_pages.payment_opt')" required>
                                    <option value="1">@lang('view_pages.cash')</option>
                                    <option value="2">@lang('view_pages.wallet')</option>
                                    <option value="4">@lang('view_pages.upi')</option>
