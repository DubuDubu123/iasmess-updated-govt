...
">Penlding Approval</button>
@else 
<button class="btn btn-success btn-sm" style="  background: #ff9900;   border-color: transparent;
">Booked</button>
@endif
    @elseif($result->status == 1)
    <button class="btn btn-primary btn-sm" style="  background: blue;   border-color: transparent;
">Checked-In</button>
...
<td><a href="{{url('room-booking/view',$result->id)}}"><span class="label label-success">View   </span></a> </td> 
</tr>
@endforeach
@endif
</tbody>
