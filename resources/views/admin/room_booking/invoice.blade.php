  ...
  <div id="invoice" class="effect2">
    <div class="page-tools" style="text-align: right;">
      ...
      <div class="action-buttons" style="margin-bottom: 20px;">
           @if($booking->status == 3)
            <button class="confimr1 btn btn-custom waves-effect waves-light  common-confirm send-payment-link" data-url="{{url('/')}}/types/send-payment-link-checkout/{{$booking->id}}" type="button" style="padding-left: 30px; padding-right: 30px; color:white;background-color:#0A7E8C;">Send Payment Link</button>
            @endif
        <a class="btn bg-white btn-light mx-1px text-95" href="{{url('/')}}/types/export_pdf/{{$booking->id}}" data-title="PDF" style="background: #0A7E8C !important; color: white;">
        ...
        <tr>
          <td colspan="2" style="text-align: center;">
            <div class="info">
              ...
              <p style="font-size: 10px; line-height: 17px; margin-bottom: 0px !important;">jsprotocol@tn.gov.in</p>
...
<tr style="width: 100%; border: 1px solid #e7e7e7;">
                <td colspan="5" style="border: 1px solid #d0d0d0; padding-top: 1px !important; padding-bottom: 0px !important;">
                    <table id="room-tariff" style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="border-bottom: 1px solid #c9c9c9;">
                                <td style="border-right: 1px solid #c9c9c9; border-bottom: 1px solid #c9c9c9; text-align: center;">Room</td>
                                <td style="border-right: 1px solid #c9c9c9; border-bottom: 1px solid #c9c9c9; text-align: center;">Guest Type</td>
                                <td style="border-bottom: 1px solid #c9c9c9; text-align: center;">Price</td>
                            </tr>
                        </thead>
                        <tbody id="tariff">
                            @foreach($pricing_details['pricing_details'] as $index => $detail)
                            <tr>
                                <td style="border-right: 1px solid #c9c9c9; border-bottom: 1px solid #c9c9c9; text-align: center;">
                                    Room {{ $index + 1 }}
                                </td>
                                <td style="border-right: 1px solid #c9c9c9; border-bottom: 1px solid #c9c9c9; text-align: center;">
                                    {{ ucfirst($detail['guest_type']) }}
                                </td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-top: 10px;">Restaurant Fee</td>
                <td style="text-align: right; color: #0A7E8C !important; font-size: 12px;"> + ₹{{$invoice->additional_charge}}</td>
            </tr>
            @endif

            <tr>
                <td colspan="2" style="text-align: left; font-weight: bold;">Total Amount</td>
                <td style="text-align: right; font-weight: bold;">
                    <b style="font-weight: bold; font-size: 17px; color: black;">₹{{$invoice->total_amount}}</b>
                </td>
            </tr>

            @if($booking->booked_price->initial_price > 0)
            <tr>
                <td colspan="2" style="text-align: left;">Advance Paid</td>
                <td style="text-align: right; color: red !important; font-size: 12px;"> - ₹{{$booking->booked_price->initial_price}}</td>
            </tr>
            @endif

            @if($invoice->amount_need_to_paid > 0)
            <tr>
                <td colspan="2" style="text-align: left;">Amount to be Paid</td>
                <td style="text-align: right; font-weight: bold;">
                    <b style="font-weight: bold; font-size: 17px; color: black;">₹{{$invoice->amount_need_to_paid + $invoice->additional_charge}}</b>
                </td>
            </tr>
            @endif
                            ...
                            popup_data(`  
                                <div class="popup-card"> 
                                    <div class="popup-card-content" style="text-align: center;"> 
                                        ...
                                        <a class="btn btn-success" style="font-size:16px;margin: auto;margin-top: 20px;" href="{{url("/")}}/room-booking/view/{{$booking->id}}">View Invoice</a>
                                    </div>
                                </div>`);
