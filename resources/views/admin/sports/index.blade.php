    ...
    <div class="col-12">
        <div class="box" style="padding: 15px 0px 15px 20px;">
                ...
                <div class="row text-center">
                    <div class="col-12">
                        <form id="sports-booking" method="post" action="">
                            @csrf
                            <div class="box" style="text-align: left; border-radius:10px; padding-left: 20px !important; padding-bottom: 20px !important; background: #fff !important;">
                                
                                <div class="font-weight-600 container" style="color:black;font-size:17px; padding: 20px 0px 20px 10px !important;margin-left:-10px;">
                                    Book a Sport
                                    <span class="party-msg active" style="font-size:14px; color:#555; margin-left:10px;">
                                ...
                                <div class="row" style="padding: 10px;">
                                    <div class="col-3" style="padding-right: 15px;">
                                        <div class="form-group">
                                            ...
                                            <select name="user" id="user" class="form-control select2" data-placeholder="Select User" style="padding:10px; height: 42px;">
                                ...
                                <div class="row" style="padding: 20px 20px 0px 0px;">
                                    <div class="col-2" style="padding-right: 15px;">
                                        <div class="form-group">
                                            <label for="subscription_type" style="font-size: 14px;">Subscription Type<span class="text-danger">*</span></label>
                                            <select name="subscription_type" id="subscription_type" class="form-control" required="" style="padding:10px; height: 42px;">
                                    ...
                                    <div class="col-3" style="padding-right: 15px;">
                                        <div class="form-group">
                                            <label for="day" id="day-label" style="font-size: 14px;">No of Days<span class="text-danger">*</span></label>
                                            <input class="form-control" type="number" id="day" name="day" value="1" required="" placeholder="" style="padding:10px; height: 42px;">
                                        </div>
                                    </div>
                                    <div class="col-2" style="padding-right: 15px;">
                                        <div class="form-group">
                                            <label for="from_date" style="font-size: 14px;">From Date<span class="text-danger">*</span></label>
                                            <input class="form-control from_date" type="date" id="from_date" name="from_date" value="" required="" style="padding: 10px; height: 42px;" min="2024-06-06">
                                        </div>
                                    </div>
                                    <div class="col-3" style="padding-right: 15px;">
                                        <div class="form-group">
                                            <label for="to_date" style="font-size: 14px;">To Date<span class="text-danger">*</span></label>
                                            <input class="form-control to_date" type="date" id="to_date" name="to_date" value="" required="" style="padding: 10px; height: 42px;" disabled="" min="2024-06-06">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-group">
                                            <label for="guest_type" id="guest_type-label" style="font-size: 14px;">Guest Type<span class="text-danger">*</span></label>
                                            <select name="guest_type" id="guest_type" class="form-control" required="" style="padding:10px; height: 42px;">
                            ...
                            <div class="table-container" style="margin: 20px 40px 20px 7px;">
                                <table style="width: 100%; text-align: left;">
                                    <tbody id="tariff">
                                        @foreach($sports_tariff as $key=>$value)
                                        <tr>
                                            <td>{{$value->name}}</td>
                                            <td>₹{{$value->daily_tariff}}</td>
                                        ...
                                        @endforeach
                                        <tr class="total" style="border: none !important; margin-top: 20px;">
                                            <td style="font-size: 17px;">Total Amount</td>
                                            <td><strong style="font-weight: 600; font-size: 25px;" id="total-amount1">₹0</strong></td>
                            ...
                            <div class="col-md-12" style="padding-right: 50px !important;">
                                <div class="form-group">
                                    <div class="col-12">
                                        <!--<button class="btn btn-sm pull-right m-5 book-now" type="button" style="padding: 10px; cursor: pointer; padding-left:30px; padding-right:30px; color:white;">Click To Pay</button>-->
                                          <button class="btn btn-sm pull-right m-5 book-now" type="button" style="padding: 10px; cursor: pointer; padding-left:30px; padding-right:30px; color:white;">Click To Pay</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="box" style="padding:15px">
                ...
                <div class="row text-center" style="width: 97%; padding: 10px 20px 20px 20px; background-color: white; margin-left: 5px;">
...
" id="total-amount1">₹0</strong></td>
        ...
        $('.check_availability').on('click', function(e) {
                ...
                $.ajax({
                            ...
                            success: function(res) { 
                            if(res.status) {
                                window.location.href = "{{url('/')}}/sports-booking/sbiepay?data="+res.data;
    // popup_init();
    // popup_data(`
    ...
    //             <a id="close-popup" class="btn btn-success" style="font-size:16px;margin: auto;margin-top: 20px;" href="#">Close</a>
    //         </div>
    //     </div>
    // `);
