                    ...
                    <div class="login-box-body text-center">
                        ...
                        <div class="print-error-msg" style="position: absolute;right: 0;left: 0;">
                            <ul class="error-style"></ul>
                                ...
                                <label id="label" for="email" style="margin-left:-200px" maxlength="25" >Username</label>
                           ...
                           <span class="ion ion-locked form-control-feedback"></span>
                                ...
                                <div class="col-md-11 mx-auto text-center p-0 login-email">
                                    <label id="label" for="password" style="margin-left:-200px" maxlength="25" >Password</label>
