...
<section class="content" style="margin-left:25px">
    ...
    margin-right: 20px;
">
<a href="http://iasmess.dubudubutechnologies.com/party-booking">
                                <button class="btn btn-danger btn-sm" type="submit">
                                    <i class="mdi mdi-keyboard-backspace mr-2" style="color:white"></i>
                                    Back                                </button>
                            </a>
 </div>
  ...
  <div id="invoice" class="effect2">
    <div class="page-tools" style="text-align: right;">
      <div class="action-buttons" style="margin-bottom: 20px;">
           @if($booking->status == 3)
            <button class="confimr1 btn btn-custom waves-effect waves-light  common-confirm send-payment-link" data-url="{{url('/')}}/party-booking/send-payment-link-checkout/{{$booking->id}}" type="button" style="padding-left: 30px; padding-right: 30px; color:white;background-color:#0A7E8C;">Send Payment Link</button>
            @endif
        <a class="btn bg-white btn-light mx-1px text-95" href="{{url('/')}}/party/export_pdf/{{$booking->id}}" data-title="PDF" style="background: #0A7E8C !important; color: white;">
    ...
    <div id="invoice1" class="effect3">
      <table style="width: 100%;">
        ...
        <tr>
          <td style="vertical-align: top; margin-top: 10px;width:200px">
            <div class="info1">
          ...
          <td colspan="2">
            <table class="table border-gray-200 mt-3">
              <tbody>
                ...
                <td class="px-0" style="padding-top:10px">Party Hall Price</td>
                <td class="text-end px-0" style="text-align: right;font-size:12px"> ₹{{$booking->party_amount}}</td>
              </tr>
                <tr>
                ...
                <td class="px-0" style="padding-top:10px">Is Lawn Included?</td>
                <td class="text-end px-0" style="text-align: right;font-size:12px">Yes</td>
              </tr>
                <tr>
                
                  <td class="px-0" style="padding-top:10px">Lawn Price</td>
                  <td class="text-end px-0" style="text-align: right;color:#0A7E8C !important;font-size:12px"> + ₹{{$booking->lawn_amount}}</td>
                </tr>
                @else
                <tr>
...
<!-- </div>?</td>-->
                ...
                <br>
                  ...
                  <td class="text-end px-0" style="text-align: right;color:#0A7E8C !important;font-size:12px"> + ₹{{$invoice->additional_charge}}</td>
                </tr>
                @endif
