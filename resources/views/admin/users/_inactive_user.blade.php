...
<!--     @if(env('APP_FOR')=='demo')
    ...
    <td><a href="{{url('users/view',$result->id)}}"><span class="label label-success">View   </span></a> </td> 
    <td>
    <button type="button" style="color:white" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
    </button>
