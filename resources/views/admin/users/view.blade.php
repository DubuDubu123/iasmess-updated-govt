...
<div class="box-header with-border" style="float: right; text-align: right; width: 100%;">
    @php
        $backUrl = url('/users'); // Default to the Pending Approval page

        if ($user->is_approve == 1 && $user->is_deleted == false) {
            $backUrl = url('/users/approved');
        } elseif ($user->is_deleted == true) {
            $backUrl = url('/users/deceased');
        }
    @endphp
                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            <div class="row">
                                ...
                                <div class="bio-row images">
                                    <p><span>Profile Picture </span><div> <img src="{{$user->profile_picture}}" width="100px" height="100px"></div> </p>
                                    <div id="image-viewer">
                                ...
                                <div class="bio-row images">
                                    <p><span>ID Proof</span><div> <img src="{{$user->proof}}" width="100px" height="100px"></p>
                                </div>
                                </div>
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function(res) { 
                                ...
                                //  $(".make-approve").removeClass("active");
                                $.toast({
                                    heading: '',
